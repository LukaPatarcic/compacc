      ...
      <div className="container">
        ...
        <div className="contact-layout">
          <form className="contact-form-wrapper" onSubmit={handleSubmit}>
            <div className="form-group">
              <input
                ...
                required
              />
              <label htmlFor="name" className="form-label">{t('form.namePlaceholder')}</label>
            </div>
            ...
            <div className="form-group">
              <input
                ...
                required
              />
              <label htmlFor="email" className="form-label">{t('form.emailPlaceholder')}</label>
            </div>
            ...
            <div className="form-group form-group-textarea">
              <textarea
                ...
                required
              />
              <label htmlFor="message" className="form-label">{t('form.messagePlaceholder')}</label>
            </div>
          ...
          <div className="contact-info">
            <h3 className="contact-company">{t('company.name')}</h3>
